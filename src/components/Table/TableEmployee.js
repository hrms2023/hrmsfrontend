            ...
            <div className="shadow overflow-hidden  border-gray-200  sm:rounded-lg">
              ...
              <div className="flex flex-row justify-between items-center text-center ml-5 ">
                <div className="flex flex-row">
                  ...
                  <div className="relative rounded-md shadow-sm ml-14">
                    <input
                      type="text"
                ...
                <div className="flex flex-row items-center text-center ">
                  ...
                  <span className= "flex flex-row  text-neutral-900 text-sm font-normal font-['Roboto'] ">Select Department  <SortDownIcon className="w-4 h-4 ml-1 #000000 items-center text-center" /></span>
                  </div>
                  <div className="mr-12">
                  <span className= "flex flex-row  text-neutral-900 text-sm font-normal font-['Roboto'] "> Select Job Type  <SortDownIcon className="w-4 h-4 ml-1 #000000 items-center text-center" /></span>
                    <p></p>
                  </div>
