            ...
            <div className="shadow overflow-hidden  border-gray-200  sm:rounded-lg">
              ...
              <div className="flex flex-row justify-between items-center text-center ml-5 ">
                ...
                <div className="flex flex-row items-center text-center ">
                  ...
                  <div class="text-right text-zinc-800 text-xs font-normal font-['Roboto'] underline flex flex-row"> <PencilIcon className="h-4 w-4 mr-1" ></PencilIcon>
                  <div className="mr-3">
                  Edit
                  </div>
                  </div>
                  ...
                  {headerGroups.map((headerGroup) => (
                    <tr {...headerGroup.getHeaderGroupProps()}>
                      {headerGroup.headers.map((column) => (
                        ...
                        <th
                          scope="col"
                          className="group px-3 py-3 text-black text-sm font-medium font-['Roboto'] "
