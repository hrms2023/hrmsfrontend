                ...
                <div className={`flex-1 ml-6 p-1 ${isMenuOpen ? '' : 'w-full h-full absolute top-20 left-0'}`}>
                    ...
                    <div className='mt-10'>
                        ...
                        <span onClick={(e) => setShowModal(true)} className='font-roboto w-4/9 flex flex-center text-white text-center items-center text-[12px] p-3 bg-[#0F3057] hover:cursor-pointer' >
                            ...
                            <span className=" flex text-center items-center  w-[130px] h-[40px]"><div className="w-[91px] h-[17px] ml-5 text-white text-sm font-semibold font-['Roboto']">Add Location</div></span>
                        </span>
                        </div>
                        <main className="max-w-6xl sm:px-6 lg:px-2 pt-4">
            <div className="">
