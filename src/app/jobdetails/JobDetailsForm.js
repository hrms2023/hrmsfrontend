...
const JobDetailsForm = ({ paramsID, userProfileImage }) => {
  ...
  return (
    <div className=''>
      <Input label={"Emaployee id :"} placeholder={""} type={"text"} value={formData.employeeCode} onChange={(value) => handleChange('employeeCode', value)} />
      <Input label={"joining Date :"} placeholder={""} type={"text"} value={formData.joiningDate} onChange={(value) => handleChange('joiningDate', value)} />
      <Input label={"Designation  :"} placeholder={""} type={"text"} value={formData.designation} onChange={(value) => handleChange('beneficdesignationiaryName', value)} />
      <Input label={"Job Offerred :"} placeholder={""} type={"text"} value={formData.jobOffered} onChange={(value) => handleChange('jobOffered', value)} />
      <Input label={"Probitaion Period :"} placeholder={""} type={"email"} value={formData.probationPeriod} onChange={(value) => handleChange('probationPeriod', value)} />
