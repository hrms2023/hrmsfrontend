...
const EducationDetailsForm = ({ paramsID, userProfileImage }) => {
  ...
  const mutation = useMutation(
    async (formData) => {
      ...
      const response = await fetch('http://localhost:8080/api/educationDetails', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className=''>
      <Input label={"Degree Type :"} placeholder={""} type={"text"} value={formData.degreeType} onChange={(value) => handleChange('joiningDate', value)} />
      <Input label={"Streem:"} placeholder={""} type={"email"} value={formData.stream} onChange={(value) => handleChange('beneficdesignationiaryName', value)} />
      <Input label={"Universty Name:"} placeholder={""} type={"email"} value={formData.universityName} onChange={(value) => handleChange('jobOffered', value)} />
      <Input label={"Roll Number:"} placeholder={""} type={"text"} value={formData.rollNumber} onChange={(value) => handleChange('probationPeriod', value)} />
      <Input label={"Year Of Passing:"} placeholder={""} type={"text"} value={formData.graduationYear} onChange={(value) => handleChange('probationPeriod', value)} />
      <Input label={"Marksheet:"} placeholder={""} type={"text"} value={formData.marksheet} onChange={(value) => handleChange('probationPeriod', value)} />
